...
'			Me.barButtonCreate.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.barButtonItem1_ItemClick);
			' 
			' barButtonChange
			' 
...
'			Me.barButtonChange.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.barButtonItem2_ItemClick);
			' 
			' barButtonDelete
			' 
...
'			Me.barButtonDelete.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.barButtonItem3_ItemClick);
			' 
			' bar3
			' 
